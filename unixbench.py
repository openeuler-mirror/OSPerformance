...
file1=path+'report/unixbench/'+hostname+'-'+date+'-01'
print(file1)
...
if os.path.exists(path + 'report/unixbench/unixbench.xlsx'):
    os.system('rm -rf ./report/unixbench/unixbench.xlsx')
...
bw.save(path + 'report/unixbench/' + 'unixbench.xlsx')
